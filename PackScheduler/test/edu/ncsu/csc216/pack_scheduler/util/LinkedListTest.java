...
/**
 * Test the custom ArrayList class
 * @author Troy Boone
 *
 */
public class LinkedListTest {
	...
	public void testAddIntE() {
		LinkedList<Object> testAdd = new LinkedList<Object>();
	...
	public void testRemoveInt() {
		LinkedList<Object> testRemove = new LinkedList<Object>();
		...
		try {
			...
			assertEquals("java.lang.IndexOutOfBoundsException: Index: 4", e.toString());
		}
		// Remove Middle
	...
	public void testSetIntE() {
		LinkedList<Object> testSet = new LinkedList<Object>();
		...
		assertEquals("today", testSet.listIterator(6).previous());
		assertFalse(testSet.listIterator(6).hasNext());
		assertTrue(testSet.listIterator(6).hasPrevious());
		assertEquals(6, testSet.listIterator(6).nextIndex());
		assertEquals(-5, testSet.listIterator(6).previousIndex());
		// Set Start
