...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringStringIntInt() {
		...
		Course c = null;
		try {
			c = new Course(null, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		...
		c = null;
		try {
			c = new Course("", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("E11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("CSC2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testCourseStringStringStringIntStringString() {
		...
		Course c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, "A");
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
			assertEquals(SECTION, c.getSection());
			assertEquals(CREDITS, c.getCredits());
	...
	public void testSetTitle() {
		Course c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
	...
	public void testGetMeetingString() {
		...
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals("MW 1:30PM-2:45PM", c1.getMeetingString());
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, 900, 1035);
		assertEquals("MW 9:00AM-10:35AM", c2.getMeetingString());
		Activity c3 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, "A");
		assertEquals("Arranged", c3.getMeetingString());
		Activity c4 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, "TH", 1145, 1425);
	...
	public void testEqualsObject() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME,
				END_TIME);
		Activity c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6 = new Course(NAME, TITLE, SECTION, CREDITS, "Different", 11, MEETING_DAYS, START_TIME, END_TIME);
		Activity c7 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, "TH", START_TIME, END_TIME);
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, 830, END_TIME);
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, 1400);
		Activity c10 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testToString() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, MEETING_DAYS, START_TIME, END_TIME);
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,11,MW,1330,1445";
		assertEquals(s1, c1.toString());

		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 11, "A");
		String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,11,A";
		assertEquals(s2, c2.toString());
	}

	/**
	 * Tests that getShortDisplayArray returns the correct comma-separated value.
	 */
	@Test
	public void testGetShortDisplayArray() {
		...
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,11,MW,1330,1445";
		assertEquals(s1, c1.toString());
		String[] test = c1.getShortDisplayArray();
		assertEquals("CSC216", test[0]);
		assertEquals("001", test[1]);
		assertEquals("Programming Concepts - Java", test[2]);
		assertEquals("MW 1:30PM-2:45PM", test[3]);
		assertEquals("11", test[4]);
	}

	/**
	 * Tests that getLongDisplayArray returns the correct comma-separated value.
	 */
	@Test
	public void testGetLongDisplayArray() {
		...
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,11,MW,1330,1445";
		assertEquals(s1, c1.toString());
		String[] test = c1.getLongDisplayArray();
		assertEquals("CSC216", test[0]);
		assertEquals("001", test[1]);
		assertEquals("Programming Concepts - Java", test[2]);
		assertEquals("4", test[3]);
		assertEquals("sesmith5", test[4]);
		assertEquals("MW 1:30PM-2:45PM", test[5]);
		assertEquals("", test[6]);
